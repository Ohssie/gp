...
<html lang="en">
  <head>
    ...
    <title>@yield('title') - CitiSumo</title>
    ...
    <div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
          <div class="navbar-header"><a href="/"><img src="/assets/citisumo.jpg" width="80px" height="50px" style="margin:10px"></img></a>
          </div>
            ...
            <ul class="nav navbar-nav navbar-right be-user-nav">
              <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="/assets/img/avatar.png" alt="Avatar"><span class="user-name">{{ $user->name }}</span></a>
                <ul role="menu" class="dropdown-menu">
                  ...
                  <!-- <li><a href="settings')}}"><span class="icon mdi mdi-settings"></span> Settings</a></li> -->
