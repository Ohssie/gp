...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="../assets/grandpayer.png">
    ...
    <div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
          <div class="navbar-header"><a href="{{ url('/') }}"><img src="{{url('assets/img/grandpayer-admin.png')}}" width="180px" height="70px"></img></a>
          </div>
