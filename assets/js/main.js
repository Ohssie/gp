...
var App = function() {
        ...
        function b() {
            ...
            }), $("li.active", m).parents(".parent").addClass("active open"), l.hasClass("be-fixed-sidebar") && ($.isXs() || c.perfectScrollbar(), $(window).resize(function() {
                p(function() {
                    $.isXs() ? c.perfectScrollbar("destroy") : c.hasClass("ps-container") ? c.perfectScrollbar("update") : c.perfectScrollbar()
...
FastClick.prototype.needsClick = function(a) {
    ...
    function c(b, c) {
        ...
        function K(b, d, k) {
            ...
            }, this), c.doubleTapThreshold)) : (_a = null, Ta.trigger("tap", [b.target]), c.tap && (l = c.tap.call(Ta, b, b.target)))) : k == p ? d !== y && d !== x || (clearTimeout(ab),
                clearTimeout(bb), _a = null, Ta.trigger("doubletap", [b.target]), c.doubleTap && (l = c.doubleTap.call(Ta, b, b.target))) : k == q && (d !== y && d !== x || (clearTimeout(ab), _a = null, Ta.trigger("longtap", [b.target]), c.longTap && (l = c.longTap.call(Ta, b, b.target)))), l
        }
